...
mod a_card_edited_inside_a_column_the_other_side_removed_keeps_it;
mod a_card_inserted_after_one_someone_removed_at_once_lands_where_that_one_was;
mod a_card_moved_into_a_column_the_other_side_removed_keeps_the_column;
...
mod a_key_removed_on_one_side_and_changed_on_the_other_keeps_the_change;
