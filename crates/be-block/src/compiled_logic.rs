...
pub struct CompiledLogicDocument {
    pub compiled: Option<CompiledLogic>,
}

impl CompiledLogicDocument {
    pub fn of(compiled: CompiledLogic) -> Self {
        Self {
...
pub type CompiledLogicContent = Document<CompiledLogicDocument>;
