...
fn nor_challenge_editor() -> LogicGridEditor {
    ...
    LogicGridEditor::detached(grid, Some(ChallengeId::Nor))
}
...
mod click_placement_uses_selected_rotation_but_drag_placement_keeps_drag_rotation;
mod component_preview_shortcuts_rotate_and_scale_selected_placement;
...
mod hotbar_drag_onto_folder_icon_reorders_after_folder_when_dragging_down;
mod hotbar_drop_onto_a_slot_in_a_later_folder_keeps_the_folder_open;
...
mod placed_components_survive_the_next_edit;
mod placement_preview_applies_component_orientation;
mod screen_and_world_points_follow_the_host_view;
