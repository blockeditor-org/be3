...
fn arrow_keys_walk_the_spreadsheet_and_enter_steps_down() {
    ...
    fixture.test.click(&format!("database-view.cell.0.{first}"));
    fixture.settle();

    assert_eq!(fixture.test.label("database-view.cell-editor.cell"), "A1");

    fixture.test.key_press(Key::ArrowDown);
    fixture.settle();

    assert_eq!(
        fixture.test.label("database-view.cell-editor.cell"),
        "A2",
        "the down arrow must move the selection rather than scroll"
    );

    fixture.test.key_press(Key::ArrowRight);
    fixture.settle();
