...
#
# crates.bzl is generated by ./scripts/buck run //:buckify from cargo's own plan for each
...
def _crate():
    ...
    if package not in crates:
        fail("{} is not a workspace member cargo knows about; run ./scripts/buck run //:buckify".format(package))
...
def cargo_example(example, extra_deps = [], env = {}, **kwargs):
    ...
    if example not in examples:
        fail("{} has no example {}; run ./scripts/buck run //:buckify".format(crate["name"], example))
