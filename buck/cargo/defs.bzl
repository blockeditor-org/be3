...
#
# crates.bzl is generated by ./scripts/buckify from cargo's own plan for each
...
def _crate():
    ...
    if package not in crates:
        fail("{} is not a workspace member cargo knows about; run ./scripts/buckify".format(package))
