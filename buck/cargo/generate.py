...
# have compiled it with there. ./scripts/buckify runs this on a worker, next to
...
def main():
    ...
    for platform, graph in graphs.items():
        ...
        for unit in units:
            ...
            entry = crate["platforms"].setdefault(
                platform,
                {"binaries": {}, "deps": [], "features": [], "test_deps": [], "test_features": []},
            )
    ...
    print("# @generated by ./scripts/buckify from the workspace's Cargo.toml files.")
